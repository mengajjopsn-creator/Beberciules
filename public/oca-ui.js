...
export function renderOca(state,selectedCell=null){
 ...
 let controls='';
 if(finished)controls=`<div class="oca-winner"><p class="eyebrow">¡META!</p><h2>Ha ganado ${name(g.winner)}.</h2><p>El último brindis va por ti.</p>${host?button('Volver a elegir juego','lobby',false,'primary'):'<p>Quien organiza puede abrir otra partida.</p>'}</div>`;
